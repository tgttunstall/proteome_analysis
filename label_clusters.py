...
# TODO:
# if .idx present, use those instead of .fa files to confirm identifier location in files
...
if __name__ == "__main__":
    ...
    if args.distributed:
        ...
        with Pool(
            ...
            processed_ids_count = pool.map(worker_process, batches)

        total_identifiers_processed = sum(processed_ids_count)
        eprint(
